...
### 03 全市场筛选
预载全市场基金代码与名称（实测 27,900 只，约 21 秒），支持按类型、收益区间、规模筛选。列表中的收益为官方披露值；回撤与夏普需要点「加入对比」后按近 3 年净值实时计算。
...
| 多只横向对比 |
|---|
| ![对比](docs/screenshots/shot-cards-3.png) |

> 截图中的基金名称、基金代码与基金经理姓名均已替换为「示例基金 A/B/C」等中性标识，仅用于展示界面结构，不代表对任何具体产品的评价。
